...
#ifndef _GxEPD2_213_T5_H_
#define _GxEPD2_213_T5_H_

#include "../GxEPD2_4G_EPD.h"

class GxEPD2_213_T5 : public GxEPD2_4G_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 104;
    static const uint16_t HEIGHT = 212;
    static const GxEPD2_4G::Panel panel = GxEPD2_4G::GDEW0213T5;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = true; // set this false for test with OTP LUT (GDEW029I6F)
    static const uint16_t power_on_time = 400; // ms
    static const uint16_t power_off_time = 250; // ms 
    static const uint16_t full_refresh_time = 3800; // ms
    static const uint16_t partial_refresh_time = 600; // ms
    // constructor
    GxEPD2_213_T5(int8_t cs, int8_t dc, int8_t rst, int8_t busy);
    // methods (virtual)
